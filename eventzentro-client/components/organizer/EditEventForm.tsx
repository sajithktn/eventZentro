...
export default function EditEventForm({
  ...
  const onSubmit = async (
    ...
    try {
      let eventData: CreateEventSchema = {
        ...data,
        bannerImage:
          data.bannerImage ||
          event.bannerImage ||
  ...
  return (
    <form
      ...
      className="h-full rounded-xl border-2 border-orange-300 bg-white p-4 shadow-sm sm:p-5"
    >
            ...
            {imagePreview ? (
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <Image
                  ...
                  alt={
                    selectedImage
                      ? "Selected event banner preview"
                      : "Current event banner preview"
                  }
                  width={160}
                  height={112}
                  unoptimized
